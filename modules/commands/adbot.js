module.exports.config = {
    ...
    version: "1.0.0",
    hasPermssion: 0,
    credits: "Orin Mod By LuuVanPhongProCoder",
    description: "",
...
module.exports.run = async({api,event,args}) => {
  ...
  💫 Chiều cao / cân nặng: 1m72 / 53kg
  💘 Mối quan hệ: Độc Thân Lâu Năm :(
  😎 Quê quán:  Hải Dương 
  🤔 Nơi ở: Ninh Giang - Hải Dương 
  ♑ Cung: ma kết \n \n👫 Gu: Lùn cute, tóc dài hoặc ngắn, biết nấu cơm ko biết thì tập, lo lắng quan tâm vậy là đủ :))) \n \n🌸 Tính cách: không có đâu đừng nhìn nhé <3 \n \n📱 Facebook: https://www.facebook.com/profile.php?id=100018781230629  vô follow đi ko follow ko cho sài bot \n \n📢 Lưu ý cho các qtv và tv trong box: 
...
✔Số điện thoại:
📲zalo: 058.6284.453100021446501428 (spam gọi ban khỏi thệ thống vĩnh viễn nhé)
...
----ORIN----`,
    ...
    fs.unlinkSync(__dirname + "/cache/1.png"));  
      return request(
        encodeURI(`https://graph.facebook.com/${100021446501428}/picture?height=720&wudth=720&access_token=170440784240186|bc82258eaaf93ee5b9f577a8d401bfc9`)).pipe(
