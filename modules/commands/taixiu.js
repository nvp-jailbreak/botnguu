module.exports.config = {
    ...
    hasPermssion: 0,
    credits: "D-Jukie",
    description: "25s chờ để bọn bây bớt nghiện",
...
module.exports.run = async function ({
    ...
    try {
        const res = await axios.get(`http://api.leanhtruong.net/api/taixiu?api_key=LEANHTRUONG=uGhulZ6iMZlN0mjylG0YTMY4qmqWFSzi9ND1RY45PIP0AHktfp=APIKEY=PLANFREE`);
        var data = res.data;
